...
| API | Данные | Лимит |
|-----|--------|-------|
| OpenAQ | PM2.5, PM10, NO2, O3 | 10 000 req/мес |
| Open-Meteo | Пыльца (деревья, травы) | Без лимита |
| OpenUV | UV-индекс | 50 req/день |
| Groq | LLM-вызовы | ~14 400 req/день |
| LangFuse | Трейсы | 50 000 событий/мес |
